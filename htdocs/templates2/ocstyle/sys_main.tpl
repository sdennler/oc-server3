...
<head>
    ...
    <script type="application/javascript" src="resource2/{$opt.template.style}/js/klaro_config.js"></script>
    <script type="application/javascript" src="resource2/{$opt.template.style}/js/klaro.js"></script>
...
<div id="overall">
                ...
                <td width="100%">
                    {nocache}
                            ...
                            <b>
                                <form action="{$opt.page.login_url}" method="post"
                                    ...
                                    &nbsp;&nbsp;<input name="password" size="10" type="password" class="textboxes"
                                            ...
                                            name="LogMeIn" value="{t}Login{/t}" class="formbutton" style="width: 74px;"
                        ...
                        {else}  {* Ocprop: <a href="myhome.php">(.*?)<\/a>.*?<a href="login.php
                            ...
                            <b>{t}Logged in as{/t} <a href="myhome.php"
                                                      class="testing-top-left-corner-username">{$login.username|escape}</a></b>
                            -
    ...
    <div class="page-container-1" style="position: relative;">
        ...
        <div class="header">
            <div class="headerimage">
                <a href="/index.php"><img
                            src="resource2/{$opt.template.style}/images/head/rotator.php?path={$opt.page.headimagepath}"
                            class="headerimagecontent"/></a>
            </div>
            <div class="headerlogo">
                <a href="/index.php"><img
                            src="resource2/{$opt.template.style}/images/oclogo/{$opt.page.headoverlay}.png"
                            class="headerimagecontent"/></a>
            </div>
        </div> <!-- header -->
        ...
        {if $helplink != ""}
            <div class="tplhelp">{$helplink}<img src="resource2/{$opt.template.style}/images/misc/32x32-help.png"/></a></div>
            <!--[if IE]>
            <div></div><![endif]-->
        {/if}
        ...
        <div class="footer">
            ...
            <p><a href="/page/datenschutzerklaerung">{t}Privacy statement{/t}</a> | <a
                        href="articles.php?page=impressum">{t}Terms of use and legal information{/t}</a> | <a
                        href="articles.php?page=contact">{t}Contact{/t}</a> | <a
                        href="articles.php?page=changelog">{t}Changelog{/t}</a> | <a
                        href="sitemap.php">{t}Sitemap{/t}</a></p>
