{literal}
    <div id="oc-banner-b" role="banner" aria-label="Spendenaufruf opencaching.de" style="display:none">
        <style>
            #oc-banner-b {
                --oc-banner-bg: #dbe6f1;
            ...
            .oc-banner-b__cta:hover,
            .oc-banner-b__cta:focus {
            ...
            .oc-banner-b__close:hover,
            .oc-banner-b__close:focus {
                color: #333;
            ...
            /* Mobile: hide illustration, stack text + CTA */
        ...
        <div class="oc-banner-b__inner">
            <!-- SVG illustration: geocaching-themed coin/heart motif (inline, aria-hidden) -->
            <svg
            ...
            >
                ...
                <!-- Heart shape -->
                <path
                    d="M26 38 C26 38 12 28 12 19.5 C12 15.4 15.1 12 19 12 C21.6 12 24 13.8 26 16 C28 13.8 30.4 12 33 12 C36.9 12 40 15.4 40 19.5 C40 28 26 38 26 38 Z"
                    fill="#3a663a"
                    opacity="0.85"
                />
                <!-- Euro sign -->
            ...
            <div class="oc-banner-b__copy">
                <p class="oc-banner-b__headline">
                    <!-- DE -->
                    Hilf uns, opencaching.de am Leben zu erhalten!
                    <!-- EN: Help us keep opencaching.de alive! -->
                </p>
                <p class="oc-banner-b__subtext">
                    <!-- DE -->
                    Der Betrieb dieser Seite kostet Geld. Jede Spende hilft – egal wie klein.
                    <!-- EN: Running this site costs money. Every donation helps – no matter how small. -->
                </p>
            </div>

            <a
                class="oc-banner-b__cta"
                id="oc-banner-b__cta-link"
                href="#"
                target="_blank"
