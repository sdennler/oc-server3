{* Seasonal Banner Template - Placeholder *}
{literal}<div id="oc-banner-a" role="banner" aria-label="Seasonal banner" style="display:none">
    <style>
        #oc-banner-a {
            --oc-banner-bg: #8B4513;
    ...
    <span class="oc-banner-a__text">
      Seasonal Banner - TODO: Customize with seasonal content
    </span>
        <a
...
<script>
    (function () {
        ...
        const STORAGE_KEY  = 'oc_banner_seasonal_dismissed';
        const BANNER_ID    = 'oc-banner-a';

        if (window.__ocBannerSeasonalInit) return;
        window.__ocBannerSeasonalInit = true;
